...
# Importacion de claes creadas
from book_manager.entities.entities import (
    EntidadBase,
    Stock,
    CotizacionDolar
)
#TypeVar crea un tipo genérico que puede ser usado para definir clases y 
# funciones que operan sobre tipos de datos que no se conocen hasta el momento 
# de la ejecución. En este caso, T es un tipo genérico que está limitado a ser una subclase de EntidadBase. 
# Esto significa que cualquier clase que herede de EntidadBase puede ser utilizada como tipo T en las clases 
# y métodos definidos a continuación.

T = TypeVar("T", bound=EntidadBase)
# NOTA: T puede representar cualquier tipo que sea EntidadBase o herede de EntidadBase.



class IRepositorio(abc.ABC, Generic[T]):
    """Interfaz para operaciones CRUD."""
    # Una clase base abstracta  (abc.ABC)es una clase que se crea principalmente para servir como modelo o contrato para otras clases
    # @abc.abstractmethod
    # Esto se utiliza sobre un método específico para 
    # indicar que las clases hijas están obligadas a implementarlo esos métodos. 
